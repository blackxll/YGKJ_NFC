...
unsigned char *pP2P_NdefMessage;
unsigned short P2P_NdefMessage_size = 0;
...
boolean P2P_NDEF_SetMessage(unsigned char *pMessage, unsigned short Message_size, void *pCb)
{
    ...
    {
    	pP2P_NdefMessage = pMessage;
    	P2P_NdefMessage_size = Message_size;
        pP2P_NDEF_PushCb = (P2P_NDEF_Callback_t*) pCb;
		return TRUE;
    }
    else
    {
    	P2P_NdefMessage_size = 0;
	...
	*pRsp_size = 0;
	...
	if (*pRsp_size == 0)
	{
		...
		case SnepClientConnected:
			...
			pRsp[6] = 0;
			pRsp[7] = 0;
			pRsp[8] = P2P_NdefMessage_size;
			memcpy(&pRsp[9], pP2P_NdefMessage, P2P_NdefMessage_size);
			*pRsp_size = 9 + P2P_NdefMessage_size;
			eP2P_SnepClient_State = NdefMsgSent;
			/* Notify application of the NDEF push */
			if(pP2P_NDEF_PushCb != NULL) pP2P_NDEF_PushCb(pP2P_NdefMessage, P2P_NdefMessage_size);
			break;
